/**
 * src/objects/traintastic/edit/signalindicatorlistmodel.h
 *
...
#ifndef SIGNAL_INDICATOR_LIST_MODEL_H
#define SIGNAL_INDICATOR_LIST_MODEL_H
...
class SignalIndicatorListModel : public QAbstractTableModel
{
    Q_OBJECT
...
public:
    ...
    explicit SignalIndicatorListModel(QObject *parent = nullptr);
...
inline bool operator==(const SignalIndicatorListModel::LightEntry& lhs, const SignalIndicatorListModel::LightEntry& rhs)
{
    return lhs.light == rhs.light && lhs.letter == rhs.letter;
}

#endif // SIGNAL_INDICATOR_LIST_MODEL_H
