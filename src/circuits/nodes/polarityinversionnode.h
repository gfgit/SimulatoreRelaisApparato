/**
 * src/circuits/nodes/polarityinversionnode.h
 *
...
#ifndef POLARITYINVERSIONNODE_H
#define POLARITYINVERSIONNODE_H

#include "abstractcircuitnode.h"

class PolarityInversionNode : public AbstractCircuitNode
{
    Q_OBJECT
public:
